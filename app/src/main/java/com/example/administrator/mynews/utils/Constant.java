...
public interface Constant {
    ...
    String[] TITLES={"社会","国内","国际","娱乐","体育","军事","科技","财经","时尚"};

    int GET_IMAGE_FROM_CAMERA=0;
    int GET_IMAGE_FROM_CALLERY=1;
    int GET_IMAGE_FROM_SERVICE=2;
    String CHAT_URL="http://op.juhe.cn/robot/index?info=";
    String QUERY="&key=d3152e854fa4be596d2f174c091d7e18";
}